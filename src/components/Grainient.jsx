...
function Grainient({
  ...
  useEffect(() => {
    ...
    const effectiveDpr = Math.min(window.devicePixelRatio || 1, lowPowerDevice ? 1 : maxDpr);
    ...
    const shouldAnimate = !(staticOnReducedMotion && prefersReducedMotion);
  ...
  }, [fps, maxDpr, staticOnReducedMotion]);
